...
Generated by Shadow Instructor Resume Analyzer
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans antialiased flex flex-col">
            {/* Navbar */}
            <nav className="shrink-0 border-b border-neutral-800 bg-black/80 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="hidden md:flex items-center gap-1">
                            ...
                            <Link href="/resume-analyzer" className="px-3 py-1.5 text-sm text-white bg-neutral-800 rounded-md">
                                Resume Analyzer
                            </Link>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        <a href="https://github.com/aryan-dani/The_Shadow_Instructor" target="_blank" rel="noopener noreferrer" className="p-2 text-neutral-400 hover:text-white transition-colors">
